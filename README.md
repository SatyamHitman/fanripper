...
![Version](https://img.shields.io/badge/version-0.1.40-FF5A5F)
...
- ✅ **100% on your device** — no password, nothing uploaded, no server holding your media.
...
| Cloud accounts made for you | ✅ Mega + Gofile | ❌ | ❌ |
...
1. Download the latest **`fanripper.zip`** from the [**Releases**](../../releases) page (or [install.fanripper.com](https://install.fanripper.com)).
...
> **Why not the Chrome Web Store?** Stores remove extensions that interact with subscription-content platforms. Fanripper ships as a signed build you load once in developer mode.

## How it works

1. **Install once** — load it from your browser's extensions page.
...
See [**docs/FAQ.md**](docs/FAQ.md) for the full list. The short version:
